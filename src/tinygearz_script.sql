...
('Lewi', 'Lie', 'Uberg', 'Smedplassveien', '18 b', 4848, 'Arendal', 95002946, 'lewiuberg@icloud.com'),
('Karen Marie', 'Lie', 'Uberg', 'Smedplassveien', '18 b', 4848, 'Arendal', 93458856, 'karenmarie@icloud.com'),
('Marit', NULL, 'Melvær', 'Lystheia', 11, 4817, 'His', 47653924, 'ma-ub@online.no'),
('Morten', 'Nielsen', 'Melvær', 'Lystheia', 11, 4817, 'His', 48128894, 'mmn@multiconsult.no'),
('Jan Georg', NULL, 'Uberg', 'Søndregate', '5 b', 7500, 'Stjørdal', 99587879, 'jan@uberg.no');
...
('Johan', NULL, 'Brasøy', 'Bringebærveien', '57', 4980, 'Gjerstad', 93885796, 'jb@tg.no', 240.00),
('Tommy', 'Normann', 'Jensen', 'Moåsbakken', 3, 4870, 'Fevik', 97971637, 'tnj@tg.no', 265.00),
('Egil Andre', NULL, 'Mortensen', 'Birketveit', 128, 4870, 'Fevik', 99294080, 'eam@tg.no', 185.00),
('Arvid', NULL, 'Lauvland', 'Skålandsveien', 98, 4900, 'Tvedestrand', 97507694, 'al@tg.no', 265.00),
('Børge', NULL, 'Rosen', 'Svennskotveien', 30, 4900, 'Tvedestrand', 90943719, 'br@tg.no', 265.00),
('Sahabettin', 'Berkan', 'Gurun', 'Dvergsnesstien', 3, 4639, 'Kristiansand S', 90930107, 'sbg@tg.no', 300.00),
('Hanne', 'Halleraker', 'Gurun', 'Dvergsnesstien', 3, 4639, 'Kristiansand S', 93458733, 'hhg@tg.no', 300.00);
